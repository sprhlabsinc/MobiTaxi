...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MOB1TAXI.MyRideActivity, MOB1TAXI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MyRideActivity.class, __md_methods);
	}


	public MyRideActivity () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MyRideActivity.class)
			mono.android.TypeManager.Activate ("MOB1TAXI.MyRideActivity, MOB1TAXI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
